...
vscode.addEventListener('click', async () => {
    tool_output + "https://img.shields.io/badge/VS%20Code-0078D7?style=for-the-badge&logo=visual-studio-code&logoColor=white"
});

github.addEventListener('click', async () => {
    tool_output + "https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white"
});
